...
scripts/
  generate-resume-pdf.mjs   Puppeteer to public/dylan-kilgore-resume.pdf
```
...
- Masonry-flavored work cards leading into image-rich detail pages
...
Search the repo for `TODO(dylan)` to find the spots where LinkedIn-sourced copy should replace the drafted text:
